mod_at_dataset_server <- function(id, pool, tables_data, reporting_effort, reporting_effort_label, ds_type) {
  moduleServer(
    id,
    function(input, output, session) {
      ...
      refresh_trigger <- mod_at_copy_server("copy_reporting_effort", tables_data, reporting_effort, reporting_effort_label, ds_type, pool, refresh_trigger)
