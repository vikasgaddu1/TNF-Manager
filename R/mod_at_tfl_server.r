mod_at_tfl_server <- function(id, pool, tables_data, reporting_effort, reporting_effort_label) {
  moduleServer(
    id,
    function(input, output, session) {
      ...
      refresh_trigger <- mod_at_copy_server("copy_reporting_effort", tables_data, reporting_effort, reporting_effort_label, "TFL", pool, refresh_trigger)
